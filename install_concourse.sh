...
echo
echo "install concourse in docker container ..."
...
echo
echo "compose version: ${compose_ver}"
echo "install path:    ${concourse_path}"
echo "concourse url:   http://$(hostname -I | cut -f1 -d' '):8080"
...
echo
echo "generate self-signed key for concourse ..."
